      ...
      <div class="home__container container grid">
          ...
          <div class="home__img">
            <svg class="home__blob" viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg">
              ...
              <g mask="url(#mask0)">
                ...
                <image class="home__blob-img" x="12" y="2" [attr.href]="data.imageSrc" [attr.alt]="data.imageAlt | translate" />
              </g>
            </svg>
          </div>

          <div class="home__data">
            <h1 class="home__title">{{ data.name | translate }}</h1>
            <h3 class="home__subtitle">{{ data.title | translate }}</h3>
            <p class="home_description">
              {{ data.description | translate }}
            </p>
            <a [href]="data.ctaHref" class="button button--flex">
              {{ data.ctaLabel | translate }} <i class="uil uil-message button__icon"></i>
            </a>
          </div>
        </div>
        <div class="home__scroll">
          <a [href]="data.scrollHref" class="home__scroll-button button--flex">
            ...
            <span class="home__scroll-name">{{ data.scrollLabel | translate }}</span>
